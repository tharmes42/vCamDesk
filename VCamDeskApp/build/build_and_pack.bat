...
%userprofile%\.nuget\packages\ilmerge\3.0.41\tools\net452\ILMerge.exe /log /ndebug /out:vCamDesk.exe vCamDesk-non-packed.exe AForge.dll AForge.Controls.dll  AForge.Imaging.dll AForge.Math.dll AForge.Video.DirectShow.dll AForge.Video.dll AForge.Vision.dll Newtonsoft.Json.dll nucs.JsonSettings.dll System.Net.Http.Formatting.dll
